...
public class PrimitiveBytevectorCopyB extends Primitive {
    @Override public String name() { return "bytevector-copy!"; }
    @Override public String info() {
        return "Syntax: (bytevector-copy! to at from) (bytevector-copy! to at from start) (bytevector-copy! to at from start end)\n" +
               "Library: (scheme base)\n" +
    ...
    public Object apply(SourcePos pos, Object[] arguments) {
        ...
        System.arraycopy(from, start, to, at, end - start);
        return new Values();
    }
}
