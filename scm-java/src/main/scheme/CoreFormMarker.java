...
public class CoreFormMarker {
    ...
    private static final Map<String, String> DOCSTRINGS = Map.ofEntries(
        Map.entry("quote",
    ...
    public CoreFormMarker(String name) {
        this.name = name;
        this.docstring = DOCSTRINGS.get(name);
    }
